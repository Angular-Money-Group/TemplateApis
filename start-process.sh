...
docker pull 590184025050.dkr.ecr.sa-east-1.amazonaws.com/api-events-prod:latest

##Changing image tag
docker image tag 590184025050.dkr.ecr.sa-east-1.amazonaws.com/api-events-prod:latest $container_name:latest
